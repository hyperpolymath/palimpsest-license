...
// Replace palimpsest-license, Palimpsest License — See README.adoc for details., just run, Palimpsest License started successfully. with actuals
= palimpsest-license — Quick Start for Users
:toc:
:toclevels: 2

== What is palimpsest-license?

Palimpsest License — See README.adoc for details.
...
[source,bash]
----
just install --portable --prefix=./palimpsest-license-portable
----
...
[source]
----
Palimpsest License started successfully.
----
...
* **Wiki**: https://github.com/hyperpolymath/palimpsest-license/wiki
