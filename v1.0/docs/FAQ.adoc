...
4. Fork the project under PMPL-1.0-or-later if guidelines conflict fundamentally with your needs
...
* Community can fork governance under PMPL-1.0-or-later terms
...
For PMPL-1.0-or-later base violations (copyright infringement), standard copyright enforcement applies.
