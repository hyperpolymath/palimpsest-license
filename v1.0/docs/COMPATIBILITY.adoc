...
PMPL-1.0 is built on PMPL-1.0-or-later and inherits its compatibility characteristics. As a file-level copyleft license, it can be combined with most other licenses in multi-license projects.
...
| **PMPL-1.0-or-later**
| ✅ Yes
| PMPL extends PMPL-1.0-or-later. PMPL-1.0-or-later code is forward-compatible with PMPL.

| **LGPL-2.1**
| ✅ Yes (secondary)
| Via PMPL-1.0-or-later Section 3.3. Combined work can be distributed under LGPL-2.1-or-later.

| **LGPL-3.0**
| ✅ Yes (secondary)
| Via PMPL-1.0-or-later Section 3.3. Combined work can be distributed under LGPL-3.0-or-later.

| **GPL-2.0**
| ✅ Yes (secondary)
| Via PMPL-1.0-or-later Section 3.3. Combined work can be distributed under GPL-2.0-or-later.

| **GPL-3.0**
| ✅ Yes (secondary)
| Via PMPL-1.0-or-later Section 3.3. Combined work can be distributed under GPL-3.0-or-later.

| **AGPL-3.0**
| ✅ Yes (secondary)
| Via PMPL-1.0-or-later Section 3.3. Combined work can be distributed under PMPL-1.0-or-later.
...
**Status**: ✅ **Compatible via PMPL-1.0-or-later Section 3.3**

**How it works**:

PMPL-1.0-or-later (and thus PMPL-1.0) allows the recipient to choose to receive the work under GPL/LGPL instead:
...
You can re-license PMPL code under GPL using PMPL-1.0-or-later Section 3.3:
...
PMPL-1.0
    ↓
PMPL-1.0-or-later (base)
    ↓
Compatible with:
├── MIT/BSD/Apache (separate files)
├── GPL/LGPL (secondary license)
├── Other PMPL-1.0-or-later code (compatible)
...
* **PMPL-1.0-or-later Compatibility**: https://www.mozilla.org/en-US/MPL/2.0/FAQ/
