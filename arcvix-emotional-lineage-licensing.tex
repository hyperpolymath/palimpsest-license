...
\toprule
\textbf{Feature} & \textbf{MIT} & \textbf{GPL-3.0} & \textbf{Apache-2.0} & \textbf{PMPL-1.0-or-later} & \textbf{CC-BY-4.0} & \textbf{PMPL-1.0} \\
\midrule
...
The PMPL-1.0-or-later~\cite{mpl2} is the direct ancestor of the PMPL-1.0. Its
...
preserving full PMPL-1.0-or-later compatibility.
...
building on the PMPL-1.0-or-later, which is already widely understood and legally
tested. The additional provisions (emotional lineage, consent layer) are
\emph{additive}---they do not modify any PMPL-1.0-or-later permission or
obligation. Code licensed under the PMPL can be combined with PMPL-1.0-or-later
