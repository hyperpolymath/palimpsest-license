{
  description = "palimpsest-license - {project-description}";
    ...
    flake-utils.lib.eachDefaultSystem (system:
      ...
      in
      {
        ...
        devShells.default = pkgs.mkShell {
          ...
          shellHook = ''
            echo "🚀 palimpsest-license development environment"
            echo "Language: deno"
            echo ""
        ...
        packages.default = pkgs.stdenv.mkDerivation {
          ...
          buildPhase = ''
            ...
            # For Ada: gprbuild -P palimpsest-license.gpr -XMODE=release
          '';

          installPhase = ''
            mkdir -p $out/bin
            # *REMINDER: Add install commands*
            # cp target/release/palimpsest-license $out/bin/  # Rust
            # cp bin/palimpsest-license $out/bin/  # Ada
          '';
        ...
        apps.default = {
          type = "app";
          program = "${self.packages.${system}.default}/bin/palimpsest-license";
        };
        ...
        checks = {
          ...
          test = pkgs.runCommand "test-palimpsest-license" {
