...
# Justfile for palimpsest-license
...
doctor:
    @echo "Running diagnostics for palimpsest-license..."
...
help-me:
    @echo "=== palimpsest-license Help ==="
    @echo "Platform: $(uname -s) $(uname -m)"
    @echo "Shell: $SHELL"
    @echo ""
    @echo "To report an issue:"
    @echo "  https://github.com/hyperpolymath/palimpsest-license/issues/new"
    @echo ""
...
# LLM context dump
llm-context:
    @echo "Project: palimpsest-license"
