...
- **Emotional Lineage:** Narrative intent and cultural context must be preserved
- **Non-Interpretive AI:** Requires explicit consent for AI training
- **Metadata Preservation:** Original metadata must remain intact

For the full licence text, visit [palimpsestlicense.org](https://palimpsestlicense.org/).
```
